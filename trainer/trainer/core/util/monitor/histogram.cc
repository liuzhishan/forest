#include "trainer/core/util/monitor/histogram.h"
...
bool Histogram::Empty() const { return stats_.Empty(); }

void Histogram::Add(uint64_t value) { stats_.Add(value); }
...
double Histogram::Median() const { return stats_.Median(); }

double Histogram::Percentile(double p) const { return stats_.Percentile(p); }
double Histogram::Average() const { return stats_.Average(); }

double Histogram::StandardDeviation() const {
  return stats_.StandardDeviation();
}

std::string Histogram::ToString() const { return stats_.ToString(); }

void Histogram::Data(HistogramData* const data) const { stats_.Data(data); }
