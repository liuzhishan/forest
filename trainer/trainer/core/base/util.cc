...
const char SniperConst::SNIPER_TRAINER[] = "sniper.trainer";
const char SniperConst::SNIPER_HUB[] = "sniper.hub";
const char SniperConst::SNIPER_PS[] = "sniper.ps";

// trainer perf
const char SniperConst::COUNT_BATCH[] = "count_batch";

// ps perf
const char SniperConst::COUNT_PULL[] = "count_pull";
const char SniperConst::COUNT_PUSH[] = "count_push";
const char SniperConst::PULL_SUCCESS[] = "pull_success";
const char SniperConst::PULL_FAIL[] = "pull_fail";
const char SniperConst::PUSH_SUCCESS[] = "push_success";
const char SniperConst::PUSH_FAIL[] = "push_fail";
const char SniperConst::BUCKET_SIZE[] = "bucket_size";
const char SniperConst::ID_COUNT[] = "id_count";

// hub perf
const char SniperConst::COUNT_MESSAGE[] = "count_message";
const char SniperConst::COUNT_MESSAGE_TIMEOUT[] = "count_message_timeout";
const char SniperConst::TOTAL[] = "total";
const char SniperConst::COUNT_AFTER_TAB_FILTER[] = "count_after_tab_filter";
const char SniperConst::COUNT_AFTER_ITEM_FILTER[] = "count_after_item_filter";
const char SniperConst::COUNT_AFTER_LABEL_EXTRACTOR[] = "count_after_label_extractor";
const char SniperConst::COUNT_SAMPLE[] = "count_sample";
const char SniperConst::COUNT_POSITIVE[] = "count_positive";
const char SniperConst::COUNT_NEGATIVE[] = "count_negative";
